...
public class ChatAdapterLocalDB extends RecyclerView.Adapter<ChatAdapterLocalDB.ViewChatHolder> {
    ...
    public ChatAdapterLocalDB(List<MessageItem> dataset, OnItemClickListener clickListener) {
        this.dataset = dataset;
        this.clickListener = clickListener;
    }

    @Override
    public ChatAdapterLocalDB.ViewChatHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new ChatAdapterLocalDB.ViewChatHolder(view, clickListener);
    }

    @Override
    public void onBindViewHolder(ChatAdapterLocalDB.ViewChatHolder holder, int position) {
